app.controller('userLoginController', function ($scope, $rootScope, $location, $window, $q, $timeout, $http, Upload, sysBitApi) {
    ...
    if ($rootScope.newUser != undefined) {
        ...
        $scope.data.userId = $rootScope.newUser.userId;
        $scope.local.pswd = $rootScope.newUser.pswd;
    }
    ...
    $scope.onlogInClick = function () {
        ...
        sysBitApi.webApi(objLogIn).then(
            ...
            function (objResp) {
                ...
                // get the list of groups login user belongs to
